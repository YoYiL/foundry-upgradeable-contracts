...
contract DeployAndUpgradeTest is StdCheats, Test {
    ...
    function testUpgradeWorks() public {
        ...
        assertEq(proxy, proxyAddress, "Proxy address should remain the same after upgrade");
        ...
        uint256 newValue = 754;
        BoxV2(proxy).setValue(newValue);
        assertEq(newValue, BoxV2(proxy).getValue());
    }
}
